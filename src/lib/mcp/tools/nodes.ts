...
export const createNodeSchema = z.object({
  ...
  tag: tagBucketSchema
    .optional()
    .default("hold")
    .describe("Tag for the node: commit (use this), discard (don't use), hold (park it), or reference. Defaults to hold."),
  position: positionSchema
    .optional()
    .describe("Position on the canvas. Auto-positioned if not provided."),
});
