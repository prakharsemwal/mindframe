import { z } from "zod";
import type { MindMapNode, MindMapEdge, TagBucket, ConversationNode } from "../types";
import {
  addNodesToProject,
  addEdgesToProject,
  generateId,
...
export const importConversationSchema = z.object({
  ...
  conversation: z.string().describe("The conversation text or bullet points to parse and import"),
  context: z
    .string()
    .optional()
    .describe(
